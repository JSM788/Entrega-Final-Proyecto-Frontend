...
import DoubleCalendar from '../components/AvailableVehicle';
import styles from '../../../shared/ui/Share.module.css';
...
const ProductDetail = () => {
  ...
  console.log("state.vehicles:", state.vehicles);
  console.log("product.itemProducts:", product?.itemProducts);
