...
export const Whatsapp = () => {
    ...
    useEffect(() => {
      const handleScroll = () => {
        ...
        setIsAtBottom(scrollPosition >= pageHeight - 50); /* 50 px */
      };
    ...
    <div>
        <a
            ...
            bottom-5 right-5 bg-green-500 text-white rounded-full p-3 shadow-lg hover:bg-green-600 focus:outline-none z-10`}
